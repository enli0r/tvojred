  ...
  <div class="aur" id="home">
    ...
    <aside class="aur-drawer" :class="{ 'is-open': menuOpen }">
      ...
      <div class="aur-drawer__foot">
        <button class="aur-btn aur-btn--cream aur-drawer__cta" @click="goTo('kontakt')">
          Zakaži termin
        </button>
      ...
      <div class="aur-wrap aur-hero__inner">
        <div class="aur-hero__copy">
          ...
          <div class="aur-hero__actions">
            <button class="aur-btn aur-btn--dark" @click="goTo('kontakt')">
              Zakaži termin
            </button>
    ...
    <footer class="aur-foot">
      <div class="aur-wrap aur-foot__inner">
        ...
        <div class="aur-foot__copy">
          © {{ new Date().getFullYear() }} Aurélie. Sva prava zadržana.
        </div>
      </div>
    </footer>
  </div>
...
.aur-num {
  ...
  color: rgba(245, 239, 233, 0.34);

  &--ink {
    color: rgba(14, 12, 11, 0.22);
  }
}
...
.aur-btn {
  ...
  &.aur-btn--dark {
    ...
    &:hover {
      ...
      box-shadow: 0 16px 34px rgba(14, 12, 11, 0.22);
    }
  }
...
.aur-play {
  ...
  &__ico {
    ...
    box-shadow:
      ...
      0 12px 28px rgba(14, 12, 11, 0.14);
    transition:
      transform 0.25s ease,
      box-shadow 0.25s ease,
      background 0.25s ease;
  ...
  &:hover &__ico {
    ...
    box-shadow:
      ...
      0 16px 34px rgba(14, 12, 11, 0.18);
  }
}
